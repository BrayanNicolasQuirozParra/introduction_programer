...
public class file_data_student {
    public  static boolean f_add_student (String p_faculty, String p_name, String p_lastname){
        //description: este método crea una nueva línea en un archivo C:/Users/NICOLAS/Documents/ejercicios.txt
        boolean result;
        try{
            File myFile = new File("C:/Users/NICOLAS/Documents/ejercicios.txt");
            if(myFile.exists()){
    ...
    public static String[][] f_all_data_students(){
        //description: Este método devuelve todos los datos (todas las líneas) del archivo C:/Users/NICOLAS/Documents/ejercicios.txt
