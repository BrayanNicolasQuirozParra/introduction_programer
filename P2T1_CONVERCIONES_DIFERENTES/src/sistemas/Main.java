...
public class Main {
	...
	/* AUTHOR:Brayan nicolas quiroz parra
	   DATE: 13/04/2020
	   DESCRIPTION: Build a program that uses different methods to Convert from ºC to ºF, Convert from ºC to ºF,K to ºC, ºC to K
	 */
        int kind_from, find_to;
        f_menu();
        kind_from= f_kind_to_grades();
        if (kind_from!=0){ // if user input 1 or2 or 3
            kind_from=f_kind_to_grades(kind_from);
            if (kind_from!=0);
            f_convert(kind_from,kind_from);

    }else{
        System.err.println(" ERROR : FINISH THE SOFWARE , THE REASON IS THE CLASS DOES IS FINIS");
    }

}
    public static void f_menu(){
        //description: this method show the menu of this sofware
        System.out.println("===================================");
        System.out.println("|           softconvert            ");
        System.out.println("|     vercion 1.0 2020/04/13       ");
        System.out.println("|        created bys: BNQP         ");
        System.out.println("===================================");
        System.out.println("input of the kind of options grades :\n 1-celcius \n 2-frarengit \n 3-kelvin ");
    }
    public static int f_kind_to_grades() {
        ...
        System.out.println("started");
            ...
            System.err.println("ERROR: FINISH THE SOFWARE, THE REASON IS THE CLASS DOES NOT EXIST");
            opt=0;
        }
        return opt;
    }
